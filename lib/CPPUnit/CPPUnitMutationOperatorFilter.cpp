...
CPPUnitMutationOperatorFilter::CPPUnitMutationOperatorFilter(
...
bool CPPUnitMutationOperatorFilter::shouldSkipTest(const std::string &testName) {
...
bool CPPUnitMutationOperatorFilter::shouldSkipInstruction(llvm::Instruction *instruction) {
